// components/NavbarContent.tsx (New File)
"use client";
...
import { usePathname, useRouter, useSearchParams } from "next/navigation"; // Keep these hooks here
            ...
            <AlertDialogContent className="bg-white p-6 rounded-lg shadow-xl border border-gray-200">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-gray-700 mt-2">
                  Are you sure you want to sign out? All unsaved data will be
                  lost, and you will be redirected to the home page.
                </AlertDialogDescription>
              </AlertDialogHeader>
