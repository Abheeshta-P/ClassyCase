...
export default function Home() {
  useEffect(() => {
    const logoutSuccessful = localStorage.getItem("postLogoutRedirectHome");

    if (logoutSuccessful == "true") {
      toast.success("You have been successfully logged out!");
      localStorage.removeItem("postLogoutRedirectHome");
    }
  }, []);
  ...
  return (
    <main className="bg-slate-50 w-full min-h-screen">
          ...
          <div className="col-span-2 px:6 lg:px-0 lg:pb-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-[500px] lg:max-w-[700px] text-center lg:text-left text-balance md:text-wrap">
                ...
                ClassyCase allows you to protect your memories, not just your
                phone case.
              </p>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="text-center order-1 tracking-tight text-balance font-bold !leading-tight text-5xl md:text-6xl text-gray-900">
              What our
              <span className="relative px-3.5">
                customers{" "}
                <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-8 text-green-600" />
              </span>
              say
            </h2>
            <img
      ...
      <section className="grainy-white">
